...
class BCL_CSS(nn.Module):
    ...
    def forward(self,d_data,p_data,target_ddi_index,target_ppi_index,
        ...
        if model_type =="contrast":
            drug_embs_sim, protein_embs_sim, loss_sim = self.model_reconstruct(dti_index, dti_labels, train_pos_dti)
